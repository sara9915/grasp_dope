...
int main(int argc, char **argv)
{
    ...
    grasp_pose.position.x = 0.45;
    grasp_pose.position.y = 0.0;
    grasp_pose.position.z = 0.07;
    goal.goal_pose_pick.pose = grasp_pose;

    /* Place pose definition */
    goal.goal_pose_place.pose.position.y = 0.40;
    goal.goal_pose_place.pose.position.x = 0.15;
    goal.goal_pose_place.pose.position.z = 0.10;
